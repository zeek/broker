...
void init_data(py::module& m) {
  ...
  data_type
    ...
    .def("as_address", [](const broker::data& d) { return get<broker::address>(d); })
    .def("as_boolean", [](const broker::data& d) { return get<broker::boolean>(d); })
    .def("as_count", [](const broker::data& d) { return get<broker::count>(d); })
    .def("as_enum_value", [](const broker::data& d) { return get<broker::enum_value>(d); })
    .def("as_integer", [](const broker::data& d) { return get<broker::integer>(d); })
    .def("as_none", [](const broker::data& d) { return get<broker::none>(d); })
    .def("as_port", [](const broker::data& d) { return get<broker::port>(d); })
    .def("as_real", [](const broker::data& d) { return get<broker::real>(d); })
    .def("as_set", [](const broker::data& d) { return get<broker::set>(d); })
    .def("as_string", [](const broker::data& d) { return py::bytes(get<std::string>(d)); })
    .def("as_subnet", [](const broker::data& d) { return get<broker::subnet>(d); })
    .def("as_table", [](const broker::data& d) { return get<broker::table>(d); })
    .def("as_timespan", [](const broker::data& d) {
        double s;
        broker::convert(get<broker::timespan>(d), s);
	return s;
	})
    .def("as_timestamp", [](const broker::data& d) {
        double s;
        broker::convert(get<broker::timestamp>(d), s);
	return s;
	})
    .def("as_vector", [](const broker::data& d) { return get<broker::vector>(d); })
