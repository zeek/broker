...
%extend data {
    ...
    bool as_bool() {
      if (broker::which($self->value) != broker::data::tag::boolean) {
    ...
    uint64_t as_count() {
      if (broker::which($self->value) != broker::data::tag::count) {
        set_swig_exception("access to wrong data variant");
        return {};
      }
    ...
    int64_t as_int() {
      if (broker::which($self->value) != broker::data::tag::integer) {
        set_swig_exception("access to wrong data variant");
        return {};
      }
    ...
    double as_real() {
      if (broker::which($self->value) != broker::data::tag::real) {
        set_swig_exception("access to wrong data variant");
        return {};
      }
    ...
    std::string as_string() {
      if (broker::which($self->value) != broker::data::tag::string) {
        set_swig_exception("access to wrong data variant");
        return {};
      }
    ...
    broker::address as_address() {
      if (broker::which($self->value) != broker::data::tag::address) {
        set_swig_exception("access to wrong data variant");
        return {};
      }
    ...
    broker::subnet as_subnet() {
      if (broker::which($self->value) != broker::data::tag::subnet) {
        set_swig_exception("access to wrong data variant");
        return {};
      }
    ...
    broker::port as_port() {
      if (broker::which($self->value) != broker::data::tag::port) {
        set_swig_exception("access to wrong data variant");
        return {};
      }
    ...
    broker::time_point as_time() {
      if (broker::which($self->value) != broker::data::tag::time) {
        set_swig_exception("access to wrong data variant");
        return {};
        }
    ...
    broker::time_duration as_duration() {
      if (broker::which($self->value) != broker::data::tag::duration) {
        set_swig_exception("access to wrong data variant");
        return {};
      }
    ...
    broker::enum_value as_enum() {
      if (broker::which($self->value) != broker::data::tag::enum_value) {
        set_swig_exception("access to wrong data variant");
        return {};
      }
    ...
    std::set<broker::data> as_set() {
      if (broker::which($self->value) != broker::data::tag::set) {
        set_swig_exception("access to wrong data variant");
        return broker::set{};
      }
    ...
    std::map<broker::data, broker::data> as_table() {
      if (broker::which($self->value) != broker::data::tag::table) {
          set_swig_exception("access to wrong data variant");
          return broker::table{};
          }
    ...
    std::vector<broker::data> as_vector() {
      if (broker::which($self->value) != broker::data::tag::vector) {
        set_swig_exception("access to wrong data variant");
        return {};
      }
    ...
    broker::record as_record() {
      if (broker::which($self->value) != broker::data::tag::record) {
        set_swig_exception("access to wrong data variant");
        return {};
      }
