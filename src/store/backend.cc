...
broker::store::modification_result
broker::store::backend::add_to_set(const data& k, data element,
                                   double mod_time) {
...
broker::store::modification_result
broker::store::backend::push_left(const data& k, vector items,
                                  double mod_time) {
...
broker::store::modification_result
broker::store::backend::push_right(const data& k, vector items,
                                   double mod_time) {
