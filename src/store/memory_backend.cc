...
broker::store::memory_backend::memory_backend() : pimpl(new impl) {
}
...
broker::store::memory_backend& broker::store::memory_backend::
...
bool broker::store::memory_backend::do_expire(
