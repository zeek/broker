...
CAF_BEGIN_TYPE_ID_BLOCK(broker_internal, caf::first_custom_type_id)
  ...
  BROKER_ADD_TYPE_ID((broker::command_envelope_ptr))
  BROKER_ADD_TYPE_ID((broker::cumulative_ack_command))
  BROKER_ADD_TYPE_ID((broker::data))
  BROKER_ADD_TYPE_ID((broker::data_envelope_ptr))
  ...
  BROKER_ADD_TYPE_ID((broker::envelope_ptr))
...
CAF_ALLOW_UNSAFE_MESSAGE_TYPE(broker::command_envelope_ptr)
CAF_ALLOW_UNSAFE_MESSAGE_TYPE(broker::data_envelope_ptr)
CAF_ALLOW_UNSAFE_MESSAGE_TYPE(broker::envelope_ptr)
CAF_ALLOW_UNSAFE_MESSAGE_TYPE(broker::ping_envelope_ptr)
CAF_ALLOW_UNSAFE_MESSAGE_TYPE(broker::pong_envelope_ptr)
