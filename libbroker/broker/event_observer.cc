...
void event_observer::on_peer_buffer_push(const endpoint_id&,
                                         const node_message&) {}

void event_observer::on_peer_buffer_pull(const endpoint_id&,
                                         const node_message&) {}
...
void event_observer::on_client_buffer_push(const endpoint_id&,
                                           const data_message&) {}

void event_observer::on_client_buffer_pull(const endpoint_id&,
                                           const data_message&) {}
