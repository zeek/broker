...
public:
  ...
  void peer_disconnected(endpoint_id peer_id, const error& reason);
  ...
  caf::error init_new_peer(endpoint_id peer, const network_info& addr,
                           const filter_type& filter, detail::native_socket fd);
  ...
  std::unordered_map<endpoint_id, filter_type, detail::fnv> peer_filters;
  ...
  std::unique_ptr<detail::connector_adapter> connector_adapter;
