...
public:
  ...
  modification_result increment(const data& k, int64_t by, double mod_time);
  ...
  /// @param mod_time the epoch time this modification is taking place.
  /// @return the result of the modification.
  modification_result add_to_set(const data& k, data element, double mod_time);
  ...
  /// @param mod_time the epoch time this modification is taking place.
  /// @return the result of the modification.
  modification_result remove_from_set(const data& k, const data& element,
                                      double mod_time);
  ...
  /// @param mod_time the epoch time this modification is taking place.
  /// @return the result of the modification.
  modification_result push_left(const data& k, vector items, double mod_time);
  ...
  /// @param mod_time the epoch time this modification is taking place.
  /// @return The result of the modification.
  modification_result push_right(const data& k, vector items, double mod_time);
...
private:
  ...
  virtual bool do_insert(data k, data v, util::optional<expiration_time> t) = 0;

  virtual modification_result do_increment(const data& k, int64_t by,
                                           double mod_time) = 0;

  virtual modification_result do_add_to_set(const data& k, data element,
                                            double mod_time) = 0;
  ...
  virtual bool do_expire(const data& k, const expiration_time& expiration) = 0;

  virtual bool do_clear() = 0;

  virtual modification_result do_push_left(const data& k, vector items,
                                           double mod_time) = 0;
