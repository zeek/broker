...
void test_address_ipv6() {
  ...
  BROKER_TEST(
    broker_address_from_string(&a, "2001:db8:0000:0000:0202:b3ff:fe1e:8329"));
  BROKER_TEST(
    broker_address_from_string(&b, "2001:db8:0:0:202:b3ff:fe1e:8329"));
  ...
  broker_address* am = 0;
  BROKER_TEST(
    broker_address_from_string(&am, "2001:db8:0000:0000:0202:b3ff:fe1e:8329"));
