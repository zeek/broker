...
static void test_prefix_matching() {
  ...
  BROKER_TEST(check_contents_ordered(
    pq_topic_a0,
    {
      message{"/", "hello"}, message{"/", "goodbye"}, message{"aaa", "hi"},
    }));
  message msg = {"bbb", "bye"};
  std::vector<message> expect;
  expect.emplace_back(msg);
  BROKER_TEST(check_contents_ordered(pq_topic_b0, expect));
  BROKER_TEST(check_contents_ordered(
    pq_topic_0,
    {
      message{"/", "hello"}, message{"/", "goodbye"}, message{"aaa", "hi"},
      message{"bbb", "bye"}, message{"topicpath", "topicmsg"},
    }));
  BROKER_TEST(check_contents_ordered(
    pq_all_0,
    {
      message{"/", "hello"}, message{"/", "grats"}, message{"/", "goodbye"},
      message{"aaa", "hi"}, message{"you're", "greedy"}, message{"bbb", "bye"},
      message{"tpath", "tmsg"}, message{"topicpath", "topicmsg"},
    }));
}
...
static void test_without_access_control() {
  ...
  BROKER_TEST(check_contents_unordered(
    pq_topic_a0, {
                   message{"0", "hi"}, message{"1", "can't think of anything"},
                 }));
  BROKER_TEST(check_contents_unordered(
    pq_topic_b0,
    {
      message{"0", "bye"}, message{"1", "still can't think of anything"},
    }));
  BROKER_TEST(check_contents_unordered(
    pq_topic_0,
    {
      message{"0", "hi"}, message{"0", "bye"}, message{"0", "topicmsg"},
      message{"1", "can't think of anything"},
      message{"1", "still can't think of anything"}, message{"1", "topicmsg"},
    }));
  BROKER_TEST(check_contents_unordered(
    pq_all_0,
    {
      message{"0", "hi"}, message{"0", "bye"}, message{"0", "tmsg"},
      message{"0", "topicmsg"}, message{"0", "What are you doing, Dave?"},
      message{"1", "can't think of anything"},
      message{"1", "still can't think of anything"}, message{"1", "tmsg"},
      message{"1", "topicmsg"}, message{"1", "My mind is going."},
    }));
  ...
  BROKER_TEST(check_contents_unordered(
    pq_topic_1,
    {
      ...
      message{"1", "can't think of anything"},
      message{"1", "still can't think of anything"}, message{"1", "topicmsg"},
      message{"2", "goodbye"}, message{"2", "hello"}, message{"2", "topicmsg"},
    }));
  BROKER_TEST(check_contents_unordered(
    pq_hal_1,
    {
      message{"0", "What are you doing, Dave?"},
      message{"1", "My mind is going."}, message{"2", "I can feel it."},
    }));

  BROKER_TEST(check_contents_unordered(
    pq_topic_b2,
    {
      message{"1", "still can't think of anything"}, message{"2", "hello"},
    }));
  BROKER_TEST(check_contents_unordered(
    pq_topic_2,
    {
...
static void test_restricted_publish() {
  ...
  BROKER_TEST(check_contents_unordered(pq_topic_a0, {
                                                      message{"0", "hi"},
                                                    }));
  BROKER_TEST(check_contents_unordered(pq_topic_b0, {
                                                      message{"0", "bye"},
                                                    }));
  BROKER_TEST(check_contents_unordered(
    pq_topic_0, {
                  message{"0", "hi"}, message{"0", "bye"},
                  message{"0", "topicmsg"}, message{"1", "topicmsg"},
                }));
  BROKER_TEST(check_contents_unordered(
    pq_all_0,
    {
  ...
  BROKER_TEST(check_contents_unordered(pq_topic_b2, {
                                                      message{"2", "hello"},
                                                    }));
  BROKER_TEST(check_contents_unordered(
    pq_topic_2, {
                  message{"1", "topicmsg"}, message{"2", "goodbye"},
                  message{"2", "hello"}, message{"2", "topicmsg"},
                }));
}
...
static void test_send_peers_only() {
  ...
  BROKER_TEST(check_contents_unordered(
    pq_topic_a1, {
                   message{"0", "hi"}, message{"2", "goodbye"},
                 }));
  BROKER_TEST(check_contents_unordered(
    pq_topic_1,
    {
  ...
  BROKER_TEST(check_contents_unordered(
    pq_hal_1,
    {
      message{"0", "What are you doing, Dave?"}, message{"2", "I can feel it."},
    }));
...
static void test_send_unsolicited() {
  ...
  node1.send("hal9000", {"1u", "My mind is going."},
             SELF | PEERS | UNSOLICITED);
  ...
  BROKER_TEST(check_contents_unordered(
    pq_topic_0,
    {
      ...
      message{"1", "still can't think of anything"}, message{"1", "topicmsg"},
      message{"1u", "can't think of anything"},
      message{"1u", "still can't think of anything"}, message{"1u", "topicmsg"},
    }));
  BROKER_TEST(check_contents_unordered(
    pq_all_0,
    {
      ...
      message{"1", "topicmsg"}, message{"1", "My mind is going."},
      message{"1u", "can't think of anything"},
      message{"1u", "still can't think of anything"}, message{"1u", "tmsg"},
      message{"1u", "topicmsg"}, message{"1u", "My mind is going."},
    }));
  ...
  BROKER_TEST(check_contents_unordered(
    ...
    {
      message{"0", "hi"}, message{"1", "can't think of anything"},
      message{"1u", "can't think of anything"}, message{"2", "goodbye"},
    }));
  BROKER_TEST(check_contents_unordered(
    pq_topic_1,
    {
  ...
  BROKER_TEST(check_contents_unordered(
    ...
    {
      message{"0", "What are you doing, Dave?"},
      message{"1", "My mind is going."}, message{"1u", "My mind is going."},
  ...
  BROKER_TEST(check_contents_unordered(
    pq_topic_b2,
    {
      message{"1u", "still can't think of anything"}, message{"2", "hello"},
    }));
  BROKER_TEST(check_contents_unordered(
    pq_topic_2,
    {
