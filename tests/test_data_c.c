...
void test_string() {
  ...
  BROKER_TEST(
    broker_string_set_cstring(broker_data_as_string(dd), "hello, world"));
  BROKER_TEST(broker_data_eq(db, dd));
  BROKER_TEST(
    !strcmp(broker_string_data(broker_data_as_string(dd)), "hello, world"));
...
void test_enum() {
  ...
  BROKER_TEST(
    !strcmp(broker_enum_value_name(broker_data_as_enum(da)), "world"));
  BROKER_TEST(!strcmp(broker_enum_value_name(a), "hello"));
