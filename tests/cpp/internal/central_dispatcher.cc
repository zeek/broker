#define SUITE internal.central_dispatcher
...
struct testee_state {
  internal::central_dispatcher dispatcher;
  internal::unipath_manager_ptr in;
  internal::unipath_manager_ptr out;
  internal::unipath_manager_ptr inout;
